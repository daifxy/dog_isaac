...
class MLPModel(nn.Module):
    ...
    def forward(
        ...
        if encoder_out is not None and self.encoder_dim is not None:
    ...
    def update_normalization(self, obs: TensorDict, encoder_out: torch.Tensor | None = None) -> None:
        ...
        if self.obs_normalization:
            ...
            if encoder_out is not None and self.encoder_dim is not None:
                mlp_obs = torch.cat([encoder_out, mlp_obs], dim=-1)
