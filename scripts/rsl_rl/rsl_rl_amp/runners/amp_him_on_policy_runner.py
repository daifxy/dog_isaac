...
# import rsl_rl
from ..algorithms import AMPHIMPPO
...
from ..utils import Normalizer, resolve_obs_groups, store_code_state
from ..utils.motion_loader import *
            ...
            with torch.inference_mode():
                for _ in range(self.num_steps_per_env):
                    ...
                    self.alg.process_env_step(
                        obs, rewards, dones, extras, next_actor_obs, amp_observation_buf_with_term
                    )
